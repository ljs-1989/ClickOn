...
public class AppUtil {
    ...
    public static void exitBy2Click(Activity mActivity,String exitMsg) {
        Timer tExit = null;
        if (isExit == false) {
            isExit = true; // 准备退出
            Toast.makeText(mActivity, exitMsg, Toast.LENGTH_SHORT).show();
            tExit = new Timer();
        ...
        /**
         * 设置对话框背景蒙层
         *  @param dimAmount [0-1] 数值越小，透明度越小
         *   @param window 当前窗体
         */
    public static void setDialogDimAmount(float dimAmount, Window window) {
